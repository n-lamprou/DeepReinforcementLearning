...
UPDATE_BATCHES = 2     # number of minibatch updates 
...
class DDPGAgent():
    ...
    def __init__(self, state_size, action_size, model, random_seed):
        """
        Initialize an Agent object.

        :param state_size (int): dimension of each state
        :param action_size (int): dimension of each action
        :param model (pytorch object, pytorch object): tuple containing Actor and Critic networks
